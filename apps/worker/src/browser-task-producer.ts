...
export function queueCompetitiveIntelligence(pool:Pool,target:{readonly deviceId:string;readonly candidateId:string},signing:Signing){
 return queueBrowserRead(pool,{...target,kind:'competitive_intelligence'},signing);
}
