...
export const bridgeCapabilitySchema = z.enum(["supplier_search", "supplier_detail", "amazon_package", "saved_search_export", "amazon_search", "product_database", "keyword_scout"]);
