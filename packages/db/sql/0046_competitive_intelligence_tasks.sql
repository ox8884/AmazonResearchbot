...
ALTER TABLE browser_tasks ADD CONSTRAINT browser_task_kind_scope CHECK (
 ...
 OR (task_kind IN ('amazon_package','amazon_search','product_database','keyword_scout','historical_data','category_trends','competitive_intelligence') AND search_run_id IS NULL AND spec_id IS NULL AND source_capture_id IS NULL)
