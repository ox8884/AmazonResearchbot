...
import {queueKeywordScout} from '../apps/worker/src/browser-task-producer.ts';
...
try{
 ...
 assert.equal((await call('/api/bridge/capabilities',{connected:true,supportedTasks:['keyword_scout'],keyFingerprint:identity.fingerprint})).status,200);
