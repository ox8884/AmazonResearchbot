...
try {
  ...
  const observations = {
    product_database: { protocol: 1, kind: 'captured', scope: 'jungle_scout_product_database', query, sourcePageUrl: 'https://members.junglescout.com/product-database', observedAt: new Date().toISOString(), snapshot: 'SECRET_SNAPSHOT_PRODUCT', records: [{ asin: 'B0JV000001', title: 'Synthetic product', sourceText: 'B0JV000001 Synthetic product' }] },
